...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-AKSCluster-ayz"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "backendterrastan0ayz"      # mettre le nom du compte de stockage créer dans le lab 1
